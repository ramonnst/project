...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en-US" class="no-js"><!--<![endif]-->
  <head>
    ...
    <title><?= (empty($title) ? ('OPNsense') : ($title)) ?></title>
    ...
    <script type="text/javascript">
        ...
        <?= file_exists(str_replace('/ui/','/usr/local/opnsense/www/','/ui/themes/' . $theme_name . '/build/js/theme.js')) ? '<script type="text/javascript" src="'.'/ui/themes/' . $theme_name . '/build/js/theme.js'.'"></script>' :'' ?>
      ...
      <header class="page-content-head">
        <div class="container-fluid">
            <ul class="list-inline">
              <li class="__mb"><h1><?= (empty($title) ? ('') : ($title)) ?></h1></li>
